...
public class TestSubjectController {
    ...
    public RespEntity<List<SubjectDto>> getSubSubjectS(@PathVariable Long id, @RequestParam("page") int page,
                                                       @RequestParam("limit") int offset) {
//        return CtrlUtil.exe(r -> r.setVal(subjectService.getSubSubjectSPage(id, page, offset)));
        return null;
    }
}
