...
public class LinkController {
    ...
    public RespEntity<TFriendlyLink> getLinkById(@PathVariable Long id) {
        return CtrlUtil.exe(r -> r.setVal(friendlyLinkService.getLinkById(id)));
    }
    ...
    public RespEntity<String> saveLink(@RequestBody TFriendlyLink friendlyLink) {
        EntityUtil.setCreate(friendlyLink);
        friendlyLinkService.saveLink(friendlyLink);
    ...
    public RespEntity<String> deleteLinkById(@PathVariable("id") Long id) {
        friendlyLinkService.deleteLinkById(id);
        return CtrlUtil.exe(r -> r.setVal("成功"));
    }
}
