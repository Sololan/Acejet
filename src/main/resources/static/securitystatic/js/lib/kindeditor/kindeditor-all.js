...
(function (window, undefined) {
    ...
    function _mediaType(src) {
        ...
        if (/\.(mp4|mp5|ogg|mpg4)(\?|$)/i.test(src)) {
            return 'video/mp4';
        }
    ...
    function _mediaImg(blankPath, attrs) {
        var width = attrs.width,
            ...
            srcTag = type === 'video/mp4' ? _mediaVideo(attrs) : _mediaEmbed(attrs),
            style = '';
        if (/\D/.test(width)) {
            style += 'width:' + width + ';';
        } else if (width > 0) {
    ...
    _plugin('core', function (K) {
        ...
        self.beforeGetHtml(function (html) {
            ...
            return html.replace(/(<(?:noscript|noscript\s[^>]*)>)([\s\S]*?)(<\/noscript>)/ig, function ($0, $1, $2, $3) {
                ...
                .replace(/<img[^>]*class="?ke-(flash|rm|media|video)"?[^>]*>/ig, function (full) {
                    ...
                    return imgAttrs.class === 'ke-video' ? _mediaVideo(attrs) : _mediaEmbed(attrs);
                })
